...
class Query extends Param
{
    ...
    */
     ...
     */
    public function __construct(var query = null) -> void
    {
     ...
     */
    public static function create(var query) -> <\Elastica\Query>
    {
        /*
        switch (true) {
            case query instanceof \Elastica\Query:
                return query;
            case query instanceof \Elastica\Query\AbstractQuery:
                return new self(query);
            case query instanceof \Elastica\Filter\AbstractFilter:
                let newQuery = new self();
                newQuery->setFilter(query);

                return newQuery;
            case empty(query):
                return new self(new \Elastica\Query\MatchAll());
            case is_array(query):
                return new self(query);
            case is_string(query):
                return new self(new \Elastica\Query\QueryString(query));
            case query instanceof AbstractSuggest:
                return new self(new \Elastica\Suggest(query));

            case query instanceof \Elastica\Suggest:
                return new self(query);
     ...
     */
    public function setRawQuery(var query)
    {
     ...
     * @return \Elastica\Query               Query object
     */
    public function setQuery(<\Elastica\Query\AbstractQuery> query) -> <\Elastica\Query>
    {
     ...
     */
    public function setFilter(<\Elastica\Filter\AbstractFilter> filter) -> <\Elastica\Query>
    {
     ...
     * @return \Elastica\Query Query object
     */
    public function setFrom(int from) -> <\Elastica\Query>
    {
     ...
     */
    public function setSort(var sortArgs) -> <\Elastica\Query>
    {
     ...
     * @link http://www.elasticsearch.org/guide/reference/api/search/sort.html
     */
    public function addSort(sort) -> <\Elastica\Query>
    {
     ...
     */
    public function setHighlight(var highlightArgs) -> <\Elastica\Query>
    {
     ...
     * @link http://www.elasticsearch.org/guide/reference/api/search/highlighting.html
     */
    public function addHighlight(var highlight) -> <\Elastica\Query>
    {
     ...
     * @return \Elastica\Query Query object
     */
    public function setSize(int size = 10) -> <\Elastica\Query>
    {
     ...
     * @return \Elastica\Query Query object
     */
    public function setLimit(int limit = 10) -> <\Elastica\Query>
    {
     ...
     */
    public function setExplain(boolean explain = true) -> <\Elastica\Query>
    {
     ...
     */
    public function setVersion(boolean version = true) -> <\Elastica\Query>
    {
     ...
     */
    public function setFields(var fields) -> <\Elastica\Query>
    {
     ...
     */
    public function setScriptFields(var scriptFields) -> <Elastica\Query>
    {
        if typeof scriptFields == "array" {
            let scriptFields = new \Elastica\ScriptFields(scriptFields);
        }
     ...
     * @return \Elastica\Query  Query object
     */
    public function addScriptField(string name, <\Elastica\Script> script)
    {
        let this->_params["script_fields"][name] = script->toArray();
     ...
     */
    public function setFacets(var facets) -> <\Elastica\Query>
    {
        var facet;

        let this->_params["facets"] = [];
     ...
     * @return \Elastica\Query               Query object
     */
    public function addFacet(<\Elastica\Facet\AbstractFacet> facet) -> <\Elastica\Query>
    {
        let this->_params["facets"][facet->getName()] = facet->toArray();
     ...
     * @return \Elastica\Query Query object
     */
    public function addAggregation(<\Elastica\Aggregation\AbstractAggregation> agg)
    {
        if (!array_key_exists("aggs", this->_params)) {
            let this->_params["aggs"] = [];
        }
        let this->_params["aggs"][agg->getName()] = agg->toArray();
        return this;
    }
    ...
    public function toArray() -> array
    {
        if !isset this->_params["query"] && this->_suggest == 0 {
            this->setQuery(new \Elastica\Query\MatchAll());
        }
     ...
     * @return \Elastica\Query                      Query object
     */
    public function setMinScore(int minScore) -> <\Elastica\Query>
    {
        if !is_numeric(minScore) {
            throw new \Elastica\Exception\InvalidException("has to be numeric param");
        }
     ...
     */
    public function setSuggest(<\Elastica\Suggest> suggest)
    {
