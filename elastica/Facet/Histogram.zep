...
class Histogram extends AbstractFacet
{
     ...
     */
    public function setField(field) -> <\Elastica\Facet\Histogram>
    {
     ...
     * @return \Elastica\Facet\Histogram
     */
    public function setInterval(interval) -> <\Elastica\Facet\Histogra>
    {
     ...
     * @return \Elastica\Facet\Histogram
     */
    public function setKeyValueFields(keyField, valueField) -> <\Elastica\Facet\Histogram>
    {
     ...
     * @return \Elastica\Facet\Histogram
     */
    public function setKeyValueScripts(keyScript, valueScript) -> <\Elastica\Facet\Histogram>
    {
     ...
     * @return \Elastica\Facet\Histogram
     */
    public function setScriptParams(array params) -> <\Elastica\Facet\Histogram>
    {
