...
class GeoDistance extends AbstractGeoDistance
{
     ...
     */
    public function __construct(string key, var location, string distance)
    {
     ...
     */
    public function setDistance(string distance) -> <\Elastica\Filter\GeoDistance>
    {
     ...
     * @return \Elastica\Filter\GeoDistance current filter
     */
    public function setDistanceType(string distanceType) -> <\Elastica\Filter\GeoDistance>
    {
     ...
     * @return \Elastica\Filter\GeoDistance current filter
     */
    public function setOptimizeBbox(optimizeBbox) -> <\Elastica\Filter\GeoDistance>
    {
