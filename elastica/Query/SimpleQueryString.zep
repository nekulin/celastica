...
class SimpleQueryString extends AbstractQuery
{
     ...
     * @param array fields
     */
    public function __construct(string query, var fields = [])
    {
        this->setQuery(query);
        if count(fields) {
     ...
     */
    public function setQuery(string query) -> <\Elastica\Query\SimpleQueryString>
    {
     ...
     * @return \Elastica\Query\SimpleQueryString
     */
    public function setFields(array fields) -> <\Elastica\Query\SimpleQueryString>
    {
     ...
     * @return \Elastica\Query\SimpleQueryString
     */
    public function setDefaultOperator(string operator) -> <\Elastica\Query\SimpleQueryString>
    {
     ...
     * @return \Elastica\Query\SimpleQueryString
     */
    public function setAnalyzer(string analyzer) -> <\Elastica\Query\SimpleQueryString>
    {
